...
async function getRows(){
	try{
		...
		const result = await pool.query(`
			select * from(
				select "REEL1" AS UID,REELSORT_1 as COD_SORT,REELDEN_1 as DEN_SORT,REELCEPI_1 as COD_CEPI,REELWIDTH_1 as REELWIDTH,REELSUBST_1 as REELSUBST,REELCLIENT_1 as REELCLIENT,DIAM_INT,DIAM_EXT,UID AS UIDGENERAL,if(c.greutate is null,0,greutate) as CANT,if(f.nume is null,'',f.nume) DEN_CLIENT
				...
				select "REEL2" AS UID,REELSORT_2 as COD_SORT,REELDEN_2 as DEN_SORT,REELCEPI_2 as COD_CEPI,REELWIDTH_2 as REELWIDTH,REELSUBST_2 as REELSUBST,REELCLIENT_2 as REELCLIENT,DIAM_INT,DIAM_EXT,UID AS UIDGENERAL,if(c.greutate is null,0,greutate) as CANT,if(f.nume is null,'',f.nume) DEN_CLIENT
					from ${tabPlanificare} p
				...
				select "REEL3" AS UID,REELSORT_3 as COD_SORT,REELDEN_3 as DEN_SORT,REELCEPI_3 as COD_CEPI,REELWIDTH_3 as REELWIDTH,REELSUBST_3 as REELSUBST,REELCLIENT_3 as REELCLIENT,DIAM_INT,DIAM_EXT,UID AS UIDGENERAL,if(c.greutate is null,0,greutate) as CANT,if(f.nume is null,'',f.nume) DEN_CLIENT
					from ${tabPlanificare} p
				...
				select "REEL4" AS UID,REELSORT_4 as COD_SORT,REELDEN_4 as DEN_SORT,REELCEPI_4 as COD_CEPI,REELWIDTH_3 as REELWIDTH,REELSUBST_4 as REELSUBST,REELCLIENT_4 as REELCLIENT,DIAM_INT,DIAM_EXT,UID AS UIDGENERAL,if(c.greutate is null,0,greutate) as CAN,if(f.nume is null,'',f.nume) DEN_CLIENT
					from ${tabPlanificare} p
