...
async function get(){
	try{
		...
		return {      
            ...
            formReelGroup: {
                formReel_1: {
					REELSORT_1: { value: rez["REELSORT_1"], label: rez["REELDEN_1"] },
					REELCEPI_1:rez["REELCEPI_1"],
                ...
                formReel_2: {
					REELSORT_2: { value: rez["REELSORT_2"], label: rez["REELDEN_2"] },
					REELCEPI_2:rez["REELCEPI_2"],
                ...
                formReel_3: {
					REELSORT_3: { value: rez["REELSORT_3"], label: rez["REELDEN_3"] },
					REELCEPI_3:rez["REELCEPI_3"],
                ...
                formReel_4: {
					REELSORT_4: { value: rez["REELSORT_4"], label: rez["REELDEN_4"] },
					REELCEPI_4:rez["REELCEPI_4"],
