...
async function genRaport(rapObj = {}) {
    try {
        ...
        const heading = [
            [{ value: "Nota de predare", style: styles.title }],
       ...
       const fileXLS = setari.pathToTemp + `NP ${moment(data_ini).format('DD-MM-YYYY HH_mm')} - ${moment(data_fin).format('DD-MM-YYYY HH_mm')}.xlsx`
